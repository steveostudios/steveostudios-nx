...
import { File, Item, pickmeWeights } from "@nx/shared-assets";
...
const PickmeEdit: React.FC<Props> = (props) => {
  ...
  return (
    <>
      <Section>
        <DisplayOptions selectedFileId={selectedFileId} name={file.name} builder={file.builder} theme={file.theme} background={file.background} instructionsContent={file.instructionsContent} />
      </Section>
      <SectionNoBorder>
        <div>
