...
import { collection, getDocs, getFirestore, onSnapshot, doc, where, query } from "firebase/firestore";
...
export const onGetFiles = async (uid: string | undefined, updateState: (data: SimpleFile[] | undefined) => void) => {
  if (uid) {
