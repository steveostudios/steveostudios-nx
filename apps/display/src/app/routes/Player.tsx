...
import { Background, Instructions, Title, Builders, Modes, UserSettings, NoFileSelected, AnyFile, PickmeFile, WheelFile, BoxesFile } from "@nx/shared-assets";
  ...
  return (
    <Container>
      {file && userSettings?.selectedFileId ? <>
        ...
        {file.builder === Builders.PICKME && <Pickme file={file as PickmeFile} />}
        {file.builder === Builders.WHEEL && <Wheel file={file as WheelFile} />}
        {file.builder === Builders.BOXES && <Boxes file={file as BoxesFile} />}
